...
public class KaKaoPayService {
	...
	public ReadyResponse payReady(String name, int totalPrice) {
        ...
        parameters.put("cid", "Fitsure");                                    // 가맹점 코드(테스트용)
        ...
        parameters.put("approval_url", "http://localhost:8080/index.html"); // 결제 성공 시 URL
        parameters.put("cancel_url", "http://localhost:8080/signup.html");      // 결제 취소 시 URL
    ...
    private HttpHeaders getHeaders() {
        ...
        headers.set("Authorization", "DEV39DE2431AD85537ACC5C207946E601A26DF54");
